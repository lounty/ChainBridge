...
const contractABI = require("../artifacts/contracts/Chainbridge.sol/Chainbridge.json").abi;

program
    .name("chainbridge-cli")
    .description("CLI tool for Chainbridge smart contract")
    .version("1.0.0");
